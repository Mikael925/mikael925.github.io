        ...
        <div class="details-content">
          ...
          <div class="stage-content-flex">
            <div class="stage-gallery">
              ...
              <a href="{{ '/Images/gp1gif1.gif' | relative_url }}" target="_blank" title="Klicka för att förstora">
                  <img src="{{ '/Images/gp1gif1.gif' | relative_url }}" alt="En placeholder-bild" class="gallery-thumbnail">
              </a>
            </div>
            <div class="stage-description">
              <p></p>
